...
const Index = (props:infoCards) => {
  ...
  return (
    <div className={`rounded-xl hover:scale-110 duration-300 p-4 my-2 md:my-0 h-[100px] md:h-[150px] w-full md:w-[23%] shadow-lg flex items-center justify-start ${props.backgroundColor}`}>
