"use client";
import { Nlinks } from "@/common/constant/profile";
...
const Notifications = () => {
  ...
  return (
    <div className="my-[15px] min-h-[70vh] shadow-xl p-3 rounded-lg bg-white">
      <h4 className="px-3 py-3 font-bold text-lg">Notifications</h4>
      <div>
        {Nlinks.map((e: any, i: number) => {
          return (
            <div
              key={i}
              className="border-b-[1px] flex items-center justify-between border-dotted px-[15px] py-3"
            >
              <h4 className="text-primary font-semibold capitalize">
                {e?.label + " notifications"}
              </h4>
              <div>
                <input
